package com.wgh.springboot.common.money;
...
public class MoneyUtil {
     ...
     * 金额相加 
     * @param value 基础值
     * @param augendValue 被加数
     * @return 
     */  
    public static BigDecimal moneyAdd(BigDecimal value,BigDecimal augendValue){
        return value.add(augendValue);
    }  
      
    /** 
     * 金额相减 
     * @param valueStr 基础值 
     * @param subtractStr 减数
     * @return 
     */  
    public static String moneySub(String valueStr,String subtractStr){
        BigDecimal value= new BigDecimal(valueStr);  
     ...
     * 金额相减 
     * @param value 基础值 
     * @param subtractValue 减数
     * @return 
     */  
    public static BigDecimal moneySub(BigDecimal value,BigDecimal subtractValue){
        return value.subtract(subtractValue);
    }  
     ...
     * @return 
     */  
    public static String moneyMul(String valueStr,String multiplicandStr){
        BigDecimal value = new BigDecimal(valueStr);  
        BigDecimal mulValue = new BigDecimal(multiplicandStr);
     ...
     * @return 
     */  
    public static BigDecimal moneyMul(BigDecimal value,BigDecimal multiplicandValue){
        return value.multiply(multiplicandValue);
    }  
